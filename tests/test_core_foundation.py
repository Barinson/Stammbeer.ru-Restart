...
class CoreFoundationTest(unittest.TestCase):
    ...
    def test_public_content_settings_drive_home_and_navigation(self) -> None:
        ...
        self.assertIn("display:grid; grid-auto-flow:column; grid-auto-columns:minmax(max-content,1fr); justify-content:stretch", html)
        self.assertIn(".nav-links a { min-width:0; padding:0 4px; text-align:center; white-space:nowrap; }", html)
