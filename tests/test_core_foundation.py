...
class CoreFoundationTest(unittest.TestCase):
    ...
    def test_public_content_settings_drive_home_and_navigation(self) -> None:
        ...
        save_public_content(
            app.conn,
            {
                ...
                "contact_email_label_1": "Заказы",
                "contact_email_value_1": "orders@stamm.test",
        ...
        self.assertEqual(content["contacts"]["emails"][0]["value"], "hello@stamm.test")
        ...
        self.assertIn("orders@stamm.test", contacts_html)
    ...
    def test_admin_content_uploads_logo_and_nav_icon_assets(self) -> None:
        ...
        self.assertIn("Preview Яндекс.Карты", admin_content_html)
        ...
        parts = [
            ...
            field("contact_email_label_0", "Основной"), field("contact_email_value_0", "admin@stamm.test"),
            field("contact_phone_label_0", "Отдел продаж"), field("contact_phone_value_0", "+7 999 000-00-00"),
