...
class CoreFoundationTest(unittest.TestCase):
    ...
    def test_public_content_settings_drive_home_and_navigation(self) -> None:
        ...
        self.assertNotIn("Москва, тестовый завод\nстроение 2", contacts_html)
        ...
        self.assertIn("map-compact-badge", contacts_html)
        self.assertIn("оценка на Яндекс Картах", contacts_html)
        ...
        self.assertNotIn("mode=search", contacts_html)
        self.assertNotIn("text=Stamm%20Test%20Brewery", contacts_html)
