...
class CoreFoundationTest(unittest.TestCase):
    ...
    def test_public_content_settings_drive_home_and_navigation(self) -> None:
        ...
        self.assertIn(".nav-links { gap:clamp(6px,2vw,10px); justify-content:space-between", html)
        ...
        self.assertIn(".home-content { background-size:cover, auto 100%; background-position:center, center top; background-attachment:scroll; }", html)
        ...
        self.assertIn("background-size:auto, cover, auto 100%", guest_html)
    ...
    def test_beer_page_content_is_cms_managed(self) -> None:
        ...
        self.assertIn(".beer-page { padding:128px 16px 48px; background-size:cover, auto 100%", html)
