...
class CoreFoundationTest(unittest.TestCase):
    ...
    def test_public_content_settings_drive_home_and_navigation(self) -> None:
        ...
        self.assertIn(".home-content { background-size:cover, cover; background-position:center, center; background-attachment:scroll, scroll; }", html)
        ...
        self.assertIn("background-attachment:scroll, scroll, scroll", guest_html)
