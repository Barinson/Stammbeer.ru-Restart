        ...
        for row, snapshot in positive_rows:
            ...
            if existing:
                ...
                conn.execute(
                    ...
                    (
                        ...
                        row.get("externalCode"), container_type, price_minor, price_type_prices_json, available_quantity, image_url, availability_for_stock(available_quantity),
                ...
                cursor = conn.execute(
                    ...
                    INSERT INTO products (
                        ...
                        container_type, price_minor, currency, price_type_prices_json, stock_quantity, image_url, availability_status,
            ...
            conn.execute(
                ...
                SET price_minor = ?, price_type_prices_json = ?, currency = 'RUB',
                    image_url = coalesce(?, image_url), last_catalog_sync_at = ?
                WHERE product_id = ?
                """,
                (price_minor, price_type_prices_json, image_url, now, product_id),
            )
