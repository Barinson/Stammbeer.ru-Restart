...
class MoyskladClient:
    ...
    def fetch_organizations(self) -> list[dict[str, Any]]:
        return [normalize_api_reference(row) for row in self._fetch_collection_rows("entity/organization")]

    def create_customer_order(self, payload: dict[str, Any]) -> dict[str, Any]:
        return self._post("entity/customerorder", payload)
    ...
    def fetch_assortment_entity(self, assortment_href: str) -> dict[str, Any]:
