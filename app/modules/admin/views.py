    ...
    if items:
        rows = "".join(
            ...
            <tr>
              ...
              <td>{escape(str(item.get('price_minor') or '—'))}</td>
        ...
        table = f"""
          <table style="width:100%; border-collapse:collapse;">
            <thead><tr><th>Название</th><th>Тара</th><th>Цена, коп.</th><th>Остаток</th><th>Источник</th><th>Публикация</th><th>Sync</th><th></th></tr></thead>
            <tbody>{rows}</tbody>
          </table>
        """
    else:
