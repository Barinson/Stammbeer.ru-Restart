...
def content_management_page(user_email: str, content: dict[str, object], result: str | None = None, error: str | None = None) -> str:
    ...
    return page(
        ...
        <style>
          ...
          .cms-news-preview {{ display:grid; grid-template-columns:minmax(220px,360px) 1fr; gap:22px; align-items:center; border-radius:22px; padding:18px; background:#0d4b4c; color:#F6F1E3; }}
