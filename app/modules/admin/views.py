    ...
    return page(
        ...
        <form method="post" action="/admin/content/save" enctype="multipart/form-data">
          <div class="card">
            ...
            <p class="muted">При загрузке нового файла он сохраняется локально и заменяет текущий logo asset на главной.</p>
          </div>
          <div class="card">
            <h3>Верхнее меню</h3>
          ...
          <div class="card">
            ...
            <table style="width:100%; border-collapse:collapse;">
              <thead><tr><th>Ключ</th><th>Ярлык</th><th>Ссылка</th><th>Порядок</th><th>Показывать</th></tr></thead>
