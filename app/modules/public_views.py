...
{BASE_CSS}
    ...
    .news-card {{ width:min(1120px,100%); display:grid; grid-template-columns:minmax(320px,560px) minmax(260px,1fr); gap:34px; align-items:center; background:var(--card-hop); border:0; border-radius:30px; padding:30px; box-shadow:0 28px 70px rgba(0,0,0,.2); }}
