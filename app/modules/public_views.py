...
BASE_CSS = """
    ...
    * { box-sizing:border-box; }
    ...
    @media (max-width:920px) {
      ...
      .top-nav { position:fixed; align-items:center; flex-direction:row; flex-wrap:wrap; gap:8px 12px; padding:10px 16px; backdrop-filter:blur(6px); }
      ...
      body > main { padding-top:var(--menu-mobile-offset,var(--mobile-menu-offset)) !important; }
    }
...
{typography_style(site_content)}
    ...
    @media (max-width:760px) {{ body.home-body > main {{ padding-top:var(--menu-mobile-offset,104px) !important; }} .home-hero {{ min-height:88vh; padding:132px 18px 54px; }} .home-title {{ font-size:clamp(44px,16vw,66px); line-height:.82; }} .home-subtitle {{ font-size:clamp(18px,6vw,26px); letter-spacing:.14em; }} .home-content {{ background-size:cover, cover; background-position:center, center; background-attachment:scroll, scroll; }} .home-news {{ min-height:auto; padding:56px 18px; }} .news-card {{ grid-template-columns:1fr; gap:20px; }} .home-logo {{ max-width:96px; max-height:96px; margin-bottom:18px; }} .news-card__image {{ border-radius:18px; }} }}
  </style>
</head>
...
{typography_style(site_content)}
    ...
    @media (max-width:880px) {{ .contacts-page {{ padding:128px 18px 46px; background-size:cover, cover; background-position:center, center; background-attachment:scroll, scroll; }} .contacts-hero {{ gap:20px; }} .contacts-info-card {{ justify-self:stretch; }} .contacts-card {{ border-radius:20px; padding:20px; }} .contacts-card p {{ font-size:15px; }} .contact-list {{ margin-top:16px; gap:8px; }} .contact-list li {{ padding:10px 0; }} .contact-list a, .contact-list strong {{ font-size:15px; }} .map-card {{ width:100%; justify-self:stretch; padding:0; }} .map-card iframe {{ min-height:220px; max-height:320px; }} }}
  </style>
</head>
<body>
...
{typography_style(site_content)}
    ...
    @media (max-width:620px) {{ .placeholder {{ padding:128px 16px 48px; background-size:cover, cover; background-position:center, center; background-attachment:scroll, scroll; }} .placeholder__card {{ padding:22px; border-radius:20px; }} .placeholder__card h1 {{ font-size:30px; }} }}
  </style>
</head>
<body>
...
{typography_style(site_content)}
    ...
    @media (max-width:720px) {{ .business-guest {{ padding:128px 18px 46px; background-size:auto, cover, cover; background-position:center, center, center; background-attachment:scroll, scroll, scroll; }} .business-guest__message {{ max-width:28rem; font-size:min(var(--business-guest-font-size), 22px); line-height:1.34; }} }}
