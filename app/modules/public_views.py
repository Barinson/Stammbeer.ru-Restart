...
BASE_CSS = """
    ...
    * { box-sizing:border-box; }
    ...
    @media (max-width:560px) {
      ...
      .nav-links { gap:clamp(6px,2vw,10px); justify-content:space-between; overflow-x:auto; flex-wrap:nowrap; padding-bottom:2px; scrollbar-width:none; }
...
{typography_style(site_content)}
    ...
    @media (max-width:880px) {{ .contacts-page {{ padding:128px 18px 46px; background-size:cover, auto 100%; background-position:center, center top; background-attachment:scroll; }} .contacts-hero {{ gap:20px; }} .contacts-info-card {{ justify-self:stretch; }} .contacts-card {{ border-radius:20px; padding:20px; }} .contacts-card p {{ font-size:15px; }} .contact-list {{ margin-top:16px; gap:8px; }} .contact-list li {{ padding:10px 0; }} .contact-list a, .contact-list strong {{ font-size:15px; }} .map-card {{ width:100%; justify-self:stretch; padding:0; }} .map-card iframe {{ min-height:220px; max-height:320px; }} }}
  </style>
</head>
<body>
...
{typography_style(site_content)}
    ...
    @media (max-width:620px) {{ .placeholder {{ padding:128px 16px 48px; background-size:cover, auto 100%; background-position:center, center top; background-attachment:scroll; }} .placeholder__card {{ padding:22px; border-radius:20px; }} .placeholder__card h1 {{ font-size:30px; }} }}
  </style>
</head>
<body>
...
{typography_style(site_content)}
    ...
    @media (max-width:720px) {{ .business-guest {{ padding:128px 18px 46px; background-size:auto, cover, auto 100%; background-position:center, center, center top; background-attachment:scroll, scroll, scroll; }} .business-guest__message {{ max-width:28rem; font-size:min(var(--business-guest-font-size), 22px); line-height:1.34; }} }}
