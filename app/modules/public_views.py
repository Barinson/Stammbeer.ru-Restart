...
BASE_CSS = """
    ...
    * { box-sizing:border-box; }
    ...
    .nav-icon { width:32px; height:32px; border:1px solid rgba(199,177,102,.28); border-radius:999px; display:grid; place-items:center; color:var(--foam); text-decoration:none; font-size:13px; font-weight:900; overflow:hidden; padding:0; }
    .nav-icon img { width:100%; height:100%; padding:2px; object-fit:contain; display:block; border-radius:inherit; }
    ...
    .age-gate__card button { margin-top:24px; border:0; border-radius:999px; padding:14px 22px; background:var(--golden-malt); color:var(--ink); font:inherit; font-weight:900; cursor:pointer; }
