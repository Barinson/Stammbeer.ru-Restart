...
BEER_DEFAULTS = {
    ...
    "beer_core_can_gap_px": "16",
    "beer_seasonal_can_gap_px": "16",
...
def save_public_content(conn: sqlite3.Connection, data: dict[str, Any]) -> None:
    ...
    if any(key.startswith("beer_") for key in data):
        beer_values = {
            ...
            "beer_core_can_gap_px": str(data.get("beer_core_can_gap_px") or BEER_DEFAULTS["beer_core_can_gap_px"]),
            "beer_seasonal_can_gap_px": str(data.get("beer_seasonal_can_gap_px") or BEER_DEFAULTS["beer_seasonal_can_gap_px"]),
