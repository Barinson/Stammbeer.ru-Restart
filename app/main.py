...
from app.modules.admin.views import admin_catalog_page, content_management_page, customer_accounts_page, dashboard, login_page, moysklad_settings_page, page, placeholder, profile_page
