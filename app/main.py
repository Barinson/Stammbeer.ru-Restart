...
from app.modules.admin.views import admin_catalog_page, dashboard, login_page, moysklad_settings_page, page, placeholder, profile_page
from app.modules.catalog.service import admin_catalog_items, public_catalog, publish_product
from app.modules.public_views import business_storefront_page, home_page, public_placeholder_page
        ...
        class Handler(BaseHTTPRequestHandler):
            ...
            def do_GET(self) -> None:  # noqa: N802
                ...
                if path in PUBLIC_PLACEHOLDER_ROUTES:
                    ...
                    self.send_html(public_placeholder_page(title, active))
                    return
